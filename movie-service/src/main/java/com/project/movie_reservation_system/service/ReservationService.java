...
public interface ReservationService {
    Reservation createReservation(ReservationRequestDto reservation, String username);

    Reservation getReservationById(long id);

    Reservation cancelReservation(long id);

    PaginationResponse<Reservation> getAllReservationsForUser(String username, int page, int pageSize);
}
